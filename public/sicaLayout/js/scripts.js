l='<div style="position:fixed;bottom:0px;text-align:center;width:99%;z-index:999" >';
l+='<script type="text/javascript"><!--';
google_ad_client = "ca-pub-6189650418921419";
/* traductornumeros */
google_ad_slot = "7298056695";
google_ad_width = 468;
google_ad_height = 15;
l+='//-->';
l+='</script>';
//l+='<script type="text/javascript" src="http://pagead2.googlesyndication.com/pagead/show_ads.js">';
l+='</script>';
...
{
if (ax==0){l=bb[0];}
if(ax==1){if (bb[1]){l+=" con "+bb[1]+deci[aa[1].length];}}
ax++
}
return (l)
}
